...
function Filter() {
  ...
  useEffect(() => {
    axios
      .post("http://localhost:5000/allproduct/filter", { ...filterData })
      .then((res) => {
        console.log(res);
        setFilter(res.data);
      })
              ...
              <Row style={{ margin: "0px 0px 0px 0px" }}>
                <Col className="col-md-12">
                  <label>
                    ...
                    <Container
                      id="sizelist"
                      style={{ display: "none", padding: "20px 0px 0px 0px" }}
                    >
                      <Row>
                        <Col>
              ...
              <Row style={{ margin: "90px 0px 50px 0px" }}>
                {filter.map((filter) => (
                  <FilterCard
                    ...
                    size={filter.size.map((x) => (
                      <span style={{ margin: "5px" }}>{x}</span>
                    ))}
                    price={filter.price}
                    image={filter.image.map((img) => (
                      <img src={img} alt="img" />
                    ))}
                  />
                ))}
